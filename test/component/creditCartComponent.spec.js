...
describe('Credit Cart Component Tests', () => {
  ...
  test('Should show card number must be 16 letter error message when Pay With Credit Card button clicked', async () => {
    const wrapper = mount(CreditCard)
    ...
    expect(errorMessage.text()).toEqual("Card Number cannot be less than 16 letter")
  })
  test('Should show cvv number must be 3 letter error message when Pay With Credit Card button clicked', async () => {
    const wrapper = mount(CreditCard)
    ...
    const errorMessage = wrapper.find('#errorSide')
    expect(errorMessage.text()).toEqual("Card CVV cannot be less than 3 letter")
  })
